...
function MessagingInboxList() {
    const { inbox, openConversation, setView, isReady, initError, refreshInbox, visibleContacts, openCreateGroup, openMessageSearch, isFavoriteConversation, toggleFavoriteConversation, closePanel, presentation, } = (0, MessagingContext_1.useMessaging)();
