...
function MessagingInboxList() {
    const { inbox, openConversation, setView, isReady, initError, refreshInbox, visibleContacts, openCreateGroup, clearConversation, deleteConversationItem, openMessageSearch, isFavoriteConversation, toggleFavoriteConversation, closePanel, } = (0, MessagingContext_1.useMessaging)();
